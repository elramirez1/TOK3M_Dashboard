  ...
  if (!data || data.length === 0 || (data.length === 1 && data[0].promedio === 0)) {
    return (
      <div className="flex flex-col items-center justify-center p-20 text-gray-500 border-2 border-dashed border-gray-800 rounded-[2.5rem] bg-[#111827]">
        ...
        <p className="font-black tracking-widest uppercase text-center">No hay datos de calidad disponibles</p>
        <p className="text-xs mt-2 text-gray-600">Asegúrate de que los filtros seleccionados contengan gestiones evaluadas.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-10 pb-20 animate-in fade-in duration-700">
      <div className="bg-[#111827] p-10 rounded-[2.5rem] border-2 border-gray-800 shadow-2xl relative overflow-hidden">
        ...
        <h3 className="text-2xl font-black text-emerald-400 uppercase italic mb-12 flex items-center gap-3">
            <span className="w-8 h-1 bg-emerald-400 block"></span> 
