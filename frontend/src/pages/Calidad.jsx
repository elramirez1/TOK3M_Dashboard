  ...
  return (
    <div className="space-y-10 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-3 bg-[#111827] p-8 rounded-[2.5rem] border-2 border-emerald-500/30 shadow-2xl">
          ...
          <div className="h-[150px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={evolucion}>
                <Tooltip content={<CustomTooltip />} />
                <Area type="monotone" dataKey="FINAL" stroke="#34d399" fill="#10B98133" strokeWidth={5} dot={true} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
