...
router.get('/cumplimiento', async (req, res) => {
    try {
        ...
        const q = `SELECT ${sel}, (SUM(tiene_riesgo)::float / NULLIF(SUM(total_gestiones), 0)) * 100 as "FINAL" FROM resumen_riesgo ${w}`;
